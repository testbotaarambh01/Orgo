    ...
    <nav className="sticky top-0 z-50 bg-white shadow-soft">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="flex h-14 items-center justify-between sm:h-16">
          <Link to="/" className="flex items-center gap-1 sm:gap-2" onClick={closeMenu}>
            <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-lg bg-gradient-to-r from-primary-600 to-secondary-600 sm:h-8 sm:w-8">
              <span className="text-sm font-bold text-white sm:text-lg">Og</span>
            </div>
            <span className="hidden text-lg font-bold text-gray-900 sm:inline sm:text-2xl">Orgo</span>
          </Link>
