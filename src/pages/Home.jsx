...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section id="why-choose-orgo" className="section bg-[#f7fbf4]">
        <div className="container-mobile">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-2 sm:mb-4">Why Choose Orgo</h2>
            <p className="text-xs sm:text-lg text-gray-600 max-w-2xl mx-auto">
              The small operational details that make fresh food feel dependable.
            </p>
          </div>
      ...
      <section className="section bg-white">
        <div className="container-mobile">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-xs sm:text-lg text-gray-600 max-w-2xl mx-auto">
              Notes from people who cook with Orgo every week.
            </p>
          </div>
        ...
        <div className="container-mobile max-w-2xl">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-lg opacity-90">
              Get organic tips, exclusive offers, and fresh product updates delivered to your inbox.
            </p>
          </div>
